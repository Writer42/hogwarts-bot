...
WAND_TYPES = "сердечная жила дракона, перо феникса, волос единорога".split(
    ", ")
PATRONUS = "персидский кот, рысь, выдра, козёл, феникс, заяц, полосатая кошка, кабан, олень, лань, горностай, терьер, лебедь, сущность в виде гномика, капибара, смываемая втулка, неведома зверюшка, человек".split(", ")
